...
*/
        ...
        mRows.add(new Row(
                crear_fragment("main", "Especie A", "suelo-desnudo"),
                crear_fragment("other-suelo", "Especie A", "suelo-desnudo") ));
        mRows.add(new Row(
                crear_fragment("recomendation", "Especie B", "toque-directo"),
                crear_fragment("other-suelo", "Especie B", "toque-directo") ));
    ...
    private Fragment crear_fragment(String tipo, String especie, String tipo_de_suelo) {

        Fragment fragment = null;
        Bundle args = new Bundle();
        switch (tipo) {
            case "main":
                fragment = new MainRecomendationFragment();
                break;
            case "recomendation":
                fragment = new RecomendationFragment();
                break;
            case "other-suelo":
                fragment = new OtherSueloFragment();
                break;
            default:
        ...
        args.putString("nombreEspecie", especie);
        // tipoDeSuelo in "suelo-desnudo", "toque-directo", "muerto-en-pie"
        args.putString("tipoDeSuelo", tipo_de_suelo);
    ...
    public void limpiar_recomendaciones(){
        mRows.clear();
    }
}
